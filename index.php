...
<body>
                    ...
                    <div class="row aos-init aos-animate" data-aos="fade-in">
                        <div class="col-md-10 col-lg-7 mx-auto">
                            ...
                            <p>
                                ...
                                presencia en la web o está buscando contratar, contáctenos <a href="#contact">aquí</a>.
                            </p>
    ...
    <main>
        ...
        <div class="nosotros" id="nosotros">
            <div class="wave" style="height: 150px; overflow: hidden;" ><svg viewBox="0 0 500 150" preserveAspectRatio="none" style="height: 100%; width: 100%; fill: #7a28dd;"><path d="M-9.02,77.47 C149.99,150.00 363.99,149.52 502.25,84.38 L501.12,182.08 L-7.89,160.38 Z" style="stroke: none;"></path></svg></div>
            <div class="nosotros-content">
                <p class="nosotros-title">SOBRE NOSOTROS</p>
                <p>
                    Hola, somos Roger y Jaime, dos estudiantes de la Institución Universitaria 
                    Americana y estamos muy emocionados de compartir con ustedes nuestras habilidades y skills 
            ...
            <div class="wave" style="height: 150px; overflow: hidden;" ><svg viewBox="0 0 500 150" preserveAspectRatio="none" style="height: 100%; width: 100%; fill: #5D17EA;"><path d="M-5.64,90.30 C202.59,206.75 246.61,6.44 502.25,103.13 L500.00,0.00 L0.00,0.00 Z" style="stroke: none;"></path></svg></div>
        </div>
    ...
    <footer>
        ...
        <div class="footer-redes">
            <button onclick="location.href='mailto:xeng_xg@hotmail.com'">
                <i class="bi bi-envelope"></i>
            </button>
        </div>

        <p class="footer-txt">Developed and designed by <a href="https://rogerofg.github.io/MiPortafolio/">Roger</a> & Jaime. ©2023. All rights reserved.</p>
    </footer>
